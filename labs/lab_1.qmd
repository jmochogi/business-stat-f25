...
In R, a function is piece of code that performs a specific task. Functions take inputs (called arguments) and return outputs. For example, the `mean()` function calculates the average of a set of numbers. Try running the following code in the console:
