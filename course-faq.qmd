...
***Question:*** How do I upload a quarto file (.qmd) to RStudio cloud? Easy! Just go to your *Files* tab, click on the blue *Upload* button, and select the file you want to upload. RStudio will upload the file and you can then open it by clicking on it. Watch the following video for a demonstration:
