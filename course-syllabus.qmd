---
title: "MATH 14400x Business Statistics"
subtitle: "Fall 2025 Syallabus"
format:
  #html: default
  pdf: default
---
...
***Open Hours:*** Mon, Wed 12.00 - 1.00 pm (walk-ins allowed), or by [appointment](https://calendly.com/jmochogi/20min?).

***Course Website:*** [Click here](https://jmochogi.github.io/business-stat-f25/).

### Meeting Times and Location

**Section 1** meets at the following times:

| Day       | Room/Hall         | Time              |
|-----------|-------------------|-------------------|
| Monday    | Williams Hall 221 | 11:00  - 11:50 am |
| Wednesday | Williams Hall 221 | 11:00  - 11:50 am |
| Thursday | Williams Hall 302 | 10:00  - 10:50 am |
| Friday    | Williams Hall 221 | 11:00 - 11:50 am |

**Section 2** meets at the following times:

| Day       | Room/Hall         | Time              |
|-----------|-------------------|-------------------|
| Monday    | Williams Hall 317 | 10:00  - 10:50 am|
| Wednesday | Williams Hall 317 | 10:00  - 10:50 am |
| Thursday | Williams Hall 302  | 11:00  - 9:50 am |
| Friday    | Williams Hall 317 |10:00  - 10:50 am |
...
Math placement in group 2 or higher, math placement assessment score of 54 or greater, or completion of 
[MATH 10400](https://catalog.ithaca.edu/undergrad/coursesaz/math/), [MATH 10800](https://catalog.ithaca.edu/undergrad/coursesaz/math/), [MATH 11100](https://catalog.ithaca.edu/undergrad/coursesaz/math/) with a grade of C - (minus) or better. 

The course is not open to students who have taken [MATH 14500](https://catalog.ithaca.edu/undergrad/coursesaz/math/) or 
[MATH 21600](https://catalog.ithaca.edu/undergrad/coursesaz/math/)  <br> 
**Attributes:** 2B, ESTS, NS, QL <br> **Number of Credits:** 4 Credits
...
We will use the following texts in this course. All books can be purchased in hard copy format on Amazon. You are not required to purchase any of these books but you are encouraged to do so if you want a hard copy. The first two books are available for free online (HTML format) and you can read them online or download them as PDF files. The third book is not available in HTML.

-   [Introduction to Modern Statistics](https://openintro-ims.netlify.app/) by Çetinkaya-Rundel, Hardin. OpenIntro Inc., $2^{nd}$ Edition, 2023. Hard copy available on [Amazon](https://www.amazon.com/dp/1943450277?ref=cm_sw_r_cp_ud_dp_84X75NFMXXJ0N6NTJAEF&ref_=cm_sw_r_cp_ud_dp_84X75NFMXXJ0N6NTJAEF&social_share=cm_sw_r_cp_ud_dp_84X75NFMXXJ0N6NTJAEF&skipTwisterOG=2).
...
MyOpenMath is an online homework system that will be used for this course. You will be required to complete homework assignments on MyOpenMath about once a week for most of the semester. The homework assignments will be based on the material covered in class and in the readings. You are expected to complete all homework assignments by the due date (indicated on Canvas).
...
-   **In-class component:** The in-class component will be closed-book and closed notes but calculators will be allowed (not on devices like cellphones and computers). You will be allowed to bring a 2-sided A4 size paper with your summary notes and/or formulas. Your sheet must contain your name and should be submitted alongside the exam.
...
b. **Oral Presentation:**
You will be required to give a 10-minute oral presentation on a question related to the course content. This will be an individual presentation and you will be expected to use R to perform the analysis. The question will be sent to you at least 24 hours before your scheduled presentation time and solutions must be submitted to Canvas by 8.00 am on the day of the presentation. You should be prepared to answer questions from your peers and the instructor.
...
-   **Aug 25:** Classes begin, Request S/D/F Option

-   **Aug 29:** Last day to audit a course

-   **Aug 31:** Last day for Add/Drop

-   **Sep 01:** Labor Day (No classes)

-   **Sep 15:** December 2025 Application for Graduation Due Online

-   **Oct 2-3:** Fall Break - No classes
...
-  **Oct 31:** Last Day to Withdraw with "W" in Fall Semester Courses
